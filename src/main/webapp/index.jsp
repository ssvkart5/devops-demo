...
<head>
    ...
    <title>SSVKART5's DevOps Lab</title>
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">SSVKART5's DevOps AWS Lab</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        <h1>Hello</h1>
        <p>This is SSVKART5's DevOps AWS Lab</p>
...
<div class="container">
    ...
    <footer>
        <p>&copy; SSVKART5's devops lab 2020-2021</p>
    </footer>
</div> <!-- /container -->
