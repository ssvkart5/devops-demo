pipeline{
    ...
    stages {
        ...
        stage ('Pubish to nexus repository'){
            steps {nexusArtifactUploader artifacts: [[artifactId: 'ssvkart5devops', classifier: '', file: 'target/ssvkart5devops-0.0.5-SNAPSHOT.war', type: 'wat']], credentialsId: 'ba2eba7f-17c9-48ca-8c96-60769372b217', groupId: 'com.ssvkart5lab', nexusUrl: '172.20.10.199:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'ssvkart5devops-SNAPSHOT', version: '0.0.5-SNAPSHOT'
            }
        }   
